...
#   api = tesserocr.PyTessBaseAPI("/usr/share/tesseract-ocr/tessdata","eng")
    api = tesserocr.PyTessBaseAPI(r"C:\Users\pwalsh\AppData\Local\Continuum\anaconda3\pkgs\tesseract-4.1.0-h82d57dc_1\tessdata","eng")
    ...
    if(quite):
        img.save(imagePath.split('.')[len(imagePath.split('.'))-2] + '_redact' + '.' + imagePath.split('.')[len(imagePath.split('.'))-1])
    else:
        img.show()

# main('3270_1.jpg', "[A-Z]", [-q])
